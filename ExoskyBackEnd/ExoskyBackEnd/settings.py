"""
Django settings for ExoskyBackEnd project.
...
SECRET_KEY = 'django-insecure-9$k+ef%&$jwceq-d-3uvxtt99kcq#5)%tl2+xlvp-y-c)1c+zm'
...
WSGI_APPLICATION = 'ExoskyBackEnd.wsgi.application'
